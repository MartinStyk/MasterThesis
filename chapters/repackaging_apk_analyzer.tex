...
Implementovaná metóda v~praxi ukázala že dokáže identifikovať aplikácie, ktoré môžu byť potenciálne prebalené. Server zaznamenal 4\,000 požiadavok na detekciu prebalených aplikácií. Detekcia prebalených aplikácií bola vykonaná pre 1\,680 rôznych APK balíčkov.  Z~tohto poču bolo 801 aplikácií vyhodnotených ako originálne verzie, 166 ako potenciálne prebalené a v~713 prípadoch nemal server dostatok dát na určenie výsledku detekcie.
