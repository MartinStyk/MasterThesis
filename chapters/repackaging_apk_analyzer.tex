...
\end{itemize}
V prípade, že majú dve aplikácie rovnaký identifikátor, je zaručené, že pochádzajú od jedného vydavateľa, ich zdrojový kód, skompilované zdrojové súbory, metadáta a všetky \zv{png} obrázky sú identické. 
...
\begin{itemize}
	...
	\item počet \zv{png} súborov v aplikácii
